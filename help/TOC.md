...
breadcrumb-title: 6.x版Cloud ManagerAEM文檔
user-guide-description: 瞭解如何使用雲管理器在雲中為AMS自我管理Adobe Experience Manager。
...
+ [AMS的雲管理器](introduction.md)
+ 概覽 {#overview}
   + [重要概念](overview/key-concepts.md)
   + [Journey用戶](overview/user-journey.md)
   + [CI/CD管道](overview/ci-cd-pipelines.md)
   + [安全性與隱私權](overview/security-and-privacy.md)
   + [說明資源](overview/help-resources.md)
   + [Cloud Manager常見問題](overview/faqs.md)
+ 必要條件 {#requirements}
   + [訪問權限](requirements/access-rights.md)
   + [原始碼存放庫](requirements/source-code-repository.md)
   + [以角色為主的權限](requirements/role-based-permissions.md)
   + [設定用戶和角色](requirements/users-and-roles.md)
   + [環境設定](requirements/environment-provisioning.md)
+ 快速入門 {#getting-started}
   + [首次登入](getting-started/first-time-login.md)
   + [程式設定](getting-started/program-setup.md)
   + 項AEM目建立 {#project-creation}
      + [使用嚮導](getting-started/using-the-wizard.md)
      + [項目設定](getting-started/project-setup.md)
      + [構建環境](getting-started/build-environment.md)
   + [配置分支](getting-started/configuring-branches.md)
   + [Dispatcher配置](getting-started/dispatcher-configurations.md)
+ 使用 {#using}
   + CI/CD管道 {#pipelines}
      + [配置生產管線](using/production-pipelines.md)
      + [配置非生產管道](using/non-production-pipelines.md)
      + [管理管道](using/managing-pipelines.md)
   + [代碼部署](using/code-deployment.md)
   + [代碼質量測試](using/code-quality-testing.md)
   + [管理環境](using/managing-environments.md)
   + [監視環境](using/monitoring-environments.md)
   + [雲管理器API](https://developer.adobe.com/experience-cloud/cloud-manager/reference/api/)
...
+ 管理代碼 {#managing-code}
   ...
   + [儲存庫](managing-code/repositories.md)
   + [與Git整合](managing-code/git-integration.md)
   + [使用多個Git儲存庫](managing-code/multiple-git-repos.md)
